...
checkbox.addEventListener("click", () => {
    if (checkbox.checked == true) {
        ...
        document.getElementById("facebook").style.color = "#0dbf8a";        document.getElementById("contactb").style.backgroundColor = "#0dbf8a";
        ...
        document.getElementById("logo").style.color = "#0f2557";
        document.getElementById("contact").style.color = "#0f2557";
        document.getElementById("services").style.color = "#0f2557";
        document.getElementById("header").style.backgroundColor = "white";
        ...
        document.getElementById("label").style.backgroundColor = "#0f2557";
